...
# README, CONTRIBUTING, REVIEWING and CHANGELOG here, a tier-1 tree's
# adding SECURITY and RELEASE_NOTES -- each pulled into a *_link.md shim
# by a myst {include}. The shims are what the code below reads, so
...
# "./REVIEWING.md" is the correct spelling there and the one links.yml
...
# destination becomes "../../REVIEWING.md", a path outside srcdir that is
